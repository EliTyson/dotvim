...
" MODIFIED to alert for modified buffer

" alert colors
let s:cterm_alert     = 220   " Modified file alert color
let s:gui_alert       = '#ffd700'
...
let g:airline#themes#ravenpower#palette.replace_modified = {'airline_c': [s:gui_alert, s:N2[1], s:cterm_alert, s:N2[3], ''] }
